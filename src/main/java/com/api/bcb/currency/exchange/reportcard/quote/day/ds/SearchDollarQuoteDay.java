package com.api.bcb.currency.exchange.reportcard.quote.day.ds;
...
public class SearchDollarQuoteDay extends SearchResult 
        implements SearchDollarQuoteDayInterface {

    private List<DailyReportCard> listDailyReportCard = new ArrayList<>();

    public SearchDollarQuoteDay(String from) {
